...
blackListTowns = ["sagonisi","respawn_west"];// Remove towns from COS
...
COScivPool = ["C_man_hunter_1_F","C_man_p_beggar_F","C_man_p_beggar_F_afro","C_man_p_fugitive_F","C_man_p_shorts_1_F","C_man_shorts_3_F","C_man_shorts_4_F","C_man_w_worker_F","LOP_Tak_Civ_Man_01","LOP_Tak_Civ_Man_02","LOP_Tak_Civ_Man_04","LOP_AFR_Civ_Man_02_S","LOP_AFR_Civ_Man_02_S","LOP_AFR_Civ_Man_03_S"];	
COSmotPool = ["LOP_TAK_Civ_Landrover","LOP_TAK_Civ_UAZ","C_Hatchback_01_F","C_Hatchback_01_sport_F","C_Offroad_01_F","C_SUV_01_F","C_Van_01_box_F","C_Van_01_fuel_F","C_Van_01_transport_F"];
